...
exports.treeToJsonText = exports.removeParentFromTree = exports.treeToText = exports.treeToPrettyText = exports.parse = exports.Item = void 0;
...
function tokenize(srcText, srcPath) {
    ...
    while (currentPos.cursor < srcText.length) {
        ...
        var tokenLiteralFound = false;
        try {
            for (var _e = (e_2 = void 0, __values(Token.LITERAL_TOKENS)), _f = _e.next(); !_f.done; _f = _e.next()) {
                var tokenStr = _f.value;
                if (srcText.startsWith(tokenStr, currentPos.cursor)) {
        ...
        var currentChar = srcText[currentPos.cursor];
    ...
    while (tokenCursor < tokens.length) {
        ...
        if (insideBody) {
            ...
            if (tokenNow.type === '}') {
                ...
                try {
                    for (var colonPositions_1 = (e_3 = void 0, __values(colonPositions)), colonPositions_1_1 = colonPositions_1.next(); !colonPositions_1_1.done; colonPositions_1_1 = colonPositions_1.next()) {
                        var pos = colonPositions_1_1.value;
                    ...
                    try {
                        if (colonPositions_1_1 && !colonPositions_1_1.done && (_a = colonPositions_1.return)) _a.call(colonPositions_1);
                    }
...
function treeToText(root, inColor) {
    ...
    var text = inBlue("{|");
    try {
        for (var _c = __values(root.attributeList), _d = _c.next(); !_d.done; _d = _c.next()) {
            var attr = _d.value;
    ...
    text += ' ' + inBlue('}[');
    try {
        for (var _e = __values(root.body), _f = _e.next(); !_f.done; _f = _e.next()) {
            var child = _f.value;
            if (typeof child === 'string') {
                text += child;
            }
 ...
 * @param root
 */
function removeParentFromTree(root) {
    var e_10, _a, e_11, _b;
    var copy = {};
    try {
        for (var _c = __values(Object.keys(root)), _d = _c.next(); !_d.done; _d = _c.next()) {
            var key = _d.value;
...
exports.removeParentFromTree = removeParentFromTree;
function treeToJsonText(root) {
    var clone = removeParentFromTree(root);
